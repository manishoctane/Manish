...
public class EmployeeFormController {
	...
	public String displayEmployeeForm(Model model,HttpServletRequest request) {
//		Employee employee = request.getAttribute("command");
//		request.setAttribute("command", new Employee(10));
//		model.addAttribute("command", new Employee(10));
